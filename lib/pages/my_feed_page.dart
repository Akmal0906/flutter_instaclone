...
class MyFeedPage extends StatefulWidget {
  ...
  final String? str;
  MyFeedPage( [this.pageController,this.str]) ;
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(onPressed:(){
            widget.pageController!.animateToPage(2, duration: Duration(milliseconds: 100), curve: Curves.easeIn);
     ...
     child: Column(
       children: [
        ...
        //  ),
         Row(
           children: [
             IconButton(onPressed: (){}, icon:const Icon(FontAwesome.heart_o,)),
